![Banner](Data/Images/FSharp-Exercism-S01E01-Basics-LuciansLusciousLasagna-Banner.png)

### FSharp-Exercism-S01E01-Basics-LuciansLusciousLasagna

This repository my work for the [Exercism](https://exercism.org/) F# track.

### Download Command
`exercism download --track=fsharp --exercise=lucians-luscious-lasagna`

### Submission Command
`exercism submit "Exercism\fsharp\lucians-luscious-lasagna\LuciansLusciousLasagna.fs"`

![Banner](Data/Images/FSharp-Exercism-S01-Basics-Title.png)
